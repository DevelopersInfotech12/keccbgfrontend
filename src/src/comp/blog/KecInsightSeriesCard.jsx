...
import { CORAL, GOLD, ICON_BLUE_DARK, PANEL_BG, PANEL_INK } from "@/comp/blog/theme";

// Content Guide Sec.7 — "KEC Insight Series" LinkedIn newsletter panel.
...
// Pair: BioEnergyBriefCard.jsx. Copy/URL sourced from lib/newsletters.js.
// 🔴 VERIFY: href in lib/newsletters.js is still a placeholder (KEC Biofuel
// company page) — swap for the real "KEC Insight Series" newsletter URL
// once client supplies it.
const DATA = NEWSLETTERS.find((n) => n.key === "kec-insight-series");

export default function KecInsightSeriesCard() {
  return (
    <a
      href={DATA.href}
      target="_blank"
    ...
    >
      ...
      <div className="flex items-center gap-4">
        <span className="grid h-12 w-12 shrink-0 place-items-center rounded-full" style={{ background: ICON_BLUE_DARK }}>
